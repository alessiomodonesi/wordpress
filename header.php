                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="nav-title">
                            ...
                            <li class="nav-item dropdown" id="menu-1">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="http://localhost/wordpress/gestito">Gestito</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="http://localhost/wordpress/referente">Referente</a></li>
                                    <li><a class="dropdown-item"
                            ...
                            <li class="nav-item dropdown" id="menu-2">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item"
                                            href="http://localhost/wordpress/fascicolo">Fascicolo</a></li>
                                    <li><a class="dropdown-item"
                                            href="http://localhost/wordpress/fascicolo-specialista">Fascicolo
                                            specialista</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown" id="menu-3">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item"
                                            href="http://localhost/wordpress/pagamento">Pagamento</a></li>
                                    <li><a class="dropdown-item"
                                            href="http://localhost/wordpress/metodo-pagamento">Metodo di pagamento</a>
                                    </li>
                                    <li><a class="dropdown-item" href="http://localhost/wordpress/acconto">Acconto</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown" id="menu-4">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="http://localhost/wordpress/ufficio">Ufficio</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>

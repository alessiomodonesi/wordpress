    ...
    function get_stati(){
      $.ajax ( {
        ...
        success     : function ( jsonData ) {
          ...
          editor.field('stato').update(options);
        }
      });
    } ;
    function get_uffici(){
      $.ajax ( {
        ...
        success     : function ( jsonData ) {
          ...
          editor.field('id_ufficio').update(options);
        }
      });
    } ;
    function get_casi(){
      $.ajax ( {
        ...
        success     : function ( jsonData ) {
          ...
          editor.field('caso').update(options);
        }
      });
    } ;

    var table = $('#single_fascicolo').DataTable( {
      language: {
      ...
      "scrollX": true,
      lengthChange: false,
      ajax: {url:"../../../Editor-PHP/controllers/single_fascicolo.php",
      ...
      columns: [
        ...
        },
        {
          ...
          render: function ( data, type, row ) {
            return '<a href="/single_referente/?id='+row.referente+'">'+row.referente_nome+' '+row.referente_middle_name+' '+row.referente_cognome+'</a>';
...
<div class="container-fluid">
  <section>
    ...
    <div class="demo-html">
      <table id="single_fascicolo" class="table table-striped table-bordered" style="width:100%">
        <thead>
        <tr>
          <th>Id</th>
          <th>Nickname</th>

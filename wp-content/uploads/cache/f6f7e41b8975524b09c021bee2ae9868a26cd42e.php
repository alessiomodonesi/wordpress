...
<script type="text/javascript" language="javascript" class="init">
  ...
  jQuery(document).ready(function($){
    editor = new $.fn.dataTable.Editor( {
      ajax:{url:"../../../Editor-PHP/controllers/acconti.php",
        data:{id_rata:<?php echo $id_rata; ?>}},
      table: "#acconti",
      fields: [
        ...
        },
        {
          name:"id_rata",
          type:"hidden",
          def:<?php echo $id_rata; ?>

        },
        {
          name:"data_pagamento",
          type:"hidden",
          def:"<?php echo date("Y-m-d"); ?>"
        },
        {label: "metodo pagamento:",
          name: "metodo_pagamento",
          type:"select",
          options:get_metodi_pagamento()
        },
        {label: "note:",
          name: "note"
        }
    ...
    function get_metodi_pagamento(){
      $.ajax ( {
        url         : '../../../Editor-PHP/controllers/metodi_pagamento.php',
        dataType    : 'json',
        type        : 'post',
        success     : function ( jsonData ) {
          ...
          editor.field('metodo_pagamento').update(options);
        }
      });
    } ;

    var table = $('#acconti').DataTable( {
      language: {
...
<div class="container-fluid">
  <section>
    ...
    <div class="demo-html">
      <table id="acconti" class="table table-striped table-bordered" style="width:100%">
        <thead>
        <tr>
          <th>ID Pagamento</th>
          <th>ID Rata</th>

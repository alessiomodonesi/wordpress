  ...
  <section>
    ...
    <div class="demo-html">
      <table id="allegati_fascicolo" class="table table-striped table-bordered" style="width:100%">
        ...
        ?>
        <?php $__currentLoopData = $result2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          <tr>
            ...
            <td><a href="<?php echo $linkURL; ?>" target="_blank"><?php echo $row->id; ?></a></td>

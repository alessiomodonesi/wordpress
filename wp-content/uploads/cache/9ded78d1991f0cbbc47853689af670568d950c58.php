...
<script type="text/javascript" language="javascript" class="init">
  ...
  jQuery(document).ready(function($){
    ...
    var table = $('#single_referente').DataTable( {
      language: {
      ...
      "scrollX": true,
      lengthChange: false,
      ajax: {url:"../../../Editor-PHP/controllers/single_referente.php",
...
<div class="container-fluid">
  <section>
    ...
    <div class="demo-html">
      <table id="single_referente" class="table table-striped table-bordered table-responsive">
        <thead>
        <tr>
          <th>Id</th>
          <th>Nome</th>

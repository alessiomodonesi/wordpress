...
<script type="text/javascript" language="javascript" class="init">
  ...
  var editor_3; // use a global for the submit and return data rendering in the examples
  jQuery(document).ready(function($){
    editor_3 = new $.fn.dataTable.Editor( {
      ajax:{url:"../../../Editor-PHP/controllers/gestiti_fascicolo.php",
        data:{id_fascicolo:<?php echo $id_fascicolo; ?>}},
      table: "#gestiti_fascicolo",
      fields: [
        {
          label: "nome:",
          name: "nome"
    ...
    var table_3 = $('#gestiti_fascicolo').DataTable( {
      language: {
      ...
      columns: [
        ...
        },
        {
          ...
          render: function ( data, type, row ) {
            return row.nome+' '+row.middle_name+' '+row.cognome;
    ...
    // Display the buttons
    new $.fn.dataTable.Buttons( table_3, [
      { extend: "create", editor: editor_3 },
      { extend: "edit", editor: editor_3 },
      { extend: "remove", editor: editor_3 }
    ] );

    table_3.buttons().container()
      .appendTo( $('.col-md-6:eq(0)', table_3.table().container() ) );
  } );
...
<div class="container-fluid">
  <section>
    ...
    <div class="demo-html">
      <table id="gestiti_fascicolo" class="table table-striped table-bordered" style="width:100%">
        <thead>
        <tr>
          <th>ID</th>
          <th>Nome</th>

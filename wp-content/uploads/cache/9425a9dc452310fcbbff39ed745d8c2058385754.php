...
<script type="text/javascript" language="javascript" class="init">
  ...
  jQuery(document).ready(function($){
    ...
    var table = $('#single_specialista').DataTable( {
      language: {
      ...
      "scrollX": true,
      lengthChange: false,
      ajax: {url:"../../../Editor-PHP/controllers/single_specialista.php",
      data:{id_specialista:<?php echo $id_specialista; ?>}},
      columns: [
...
<div class="container-fluid">
  <section>
    ...
    <div class="demo-html">
      <table id="single_specialista" class="table table-striped table-bordered table-responsive">
        <thead>
        <tr>
          <th>Id</th>
          <th>Nome</th>

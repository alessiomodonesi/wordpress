...
<script type="text/javascript" language="javascript" class="init">
  ...
  jQuery(document).ready(function($){
    editor_2 = new $.fn.dataTable.Editor( {
      ajax:{url:"../../../Editor-PHP/controllers/fascicoli.php",
        data:{id_referente:<?php echo $id_referente; ?>}},
      table: "#fascicoli_referente",
      fields: [
        {
          label: "nickname:",
          name: "nickname"
        ...
        {
          label:"numero gestiti:",
          name:"persone_gestite"
        },
        {
          label: "data apertura:",
          name: "data_apertura",
    ...
    function get_stati(){
      $.ajax ( {
        url         : '../../../Editor-PHP/controllers/stati.php',
        dataType    : 'json',
        type        : 'post',
        success     : function ( jsonData ) {
          ...
          editor_2.field('stato').update(options);
        }
      });
    } ;
    function get_uffici(){
      $.ajax ( {
        url         : '../../../Editor-PHP/controllers/uffici.php',
        dataType    : 'json',
        type        : 'post',
        success     : function ( jsonData ) {
          var options = jsonData.data.map( item => {
          ...
          editor_2.field('id_ufficio').update(options);
        }
      });
    } ;
    function get_casi(){
      $.ajax ( {
        url         : '../../../Editor-PHP/controllers/casi.php',
        dataType    : 'json',
        type        : 'post',
        success     : function ( jsonData ) {
          var options = jsonData.data.map( item => {
          ...
          editor_2.field('caso').update(options);
        }
      });
    } ;

    var table_2 = $('#fascicoli_referente').DataTable( {
      language: {
      ...
      "scrollX": true,
      lengthChange: false,
      ajax: {url:"../../../Editor-PHP/controllers/fascicoli_referente.php",
        data:{id_referente:<?php echo $id_referente; ?>}},
      columns: [
...
<div class="container-fluid">
  <section>
    ...
    <div class="demo-html">
      <table id="fascicoli_referente" class="table table-striped table-bordered" style="width:100%">
        <thead>
        <tr>
          <th>Id</th>
          <th>Nickname</th>

...
<script type="text/javascript" language="javascript" class="init">
  ...
  jQuery(document).ready(function($){
    editor = new $.fn.dataTable.Editor( {
      ajax:{url:"../../../Editor-PHP/controllers/rate_pagamento.php",
        data:{id_pagamento:<?php echo $id_pagamento; ?>}},
      table: "#rate_pagamento",
      fields: [
    ...
    var table = $('#rate_pagamento').DataTable( {
      language: {
      ...
      columns: [
          ...
          }},
        {
          data: "id_rata",
          render: function ( data, type, row ) {
            return '<a href="/single_rata?id='+data+'">'+data+'</a>';
...
<div class="container-fluid">
  <section>
    ...
    <div class="demo-html">
      <table id="rate_pagamento" class="table table-striped table-bordered" style="width:100%">
        <thead>
        <tr>
          <th>ID Fascicolo</th>
          <th>ID Rata</th>

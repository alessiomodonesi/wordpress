...
<script type="text/javascript" language="javascript" class="init">
  ...
  var editor_5; // use a global for the submit and return data rendering in the examples
  jQuery(document).ready(function($){
    editor_5 = new $.fn.dataTable.Editor( {
      ajax:{url:"../../../Editor-PHP/controllers/spese_fascicolo_edit.php",
        data:{id_fascicolo:<?php echo $id_fascicolo; ?>}},
      table: "#spese_fascicolo",
      fields: [
        {
          label: "somma in euro:",
          name: "somma_euro"
    ...
    var table_5 = $('#spese_fascicolo').DataTable( {
      language: {
      ...
      "scrollX": true,
      lengthChange: false,
      ajax: {url:"../../../Editor-PHP/controllers/spese_fascicolo.php",
        data:{id_fascicolo:<?php echo $id_fascicolo; ?>,
      }},
      columns: [
    ...
    // Display the buttons
    new $.fn.dataTable.Buttons( table_5, [
      { extend: "create", editor: editor_5 },
      { extend: "edit", editor: editor_5 }
    ] );

    table_5.buttons().container()
      .appendTo( $('.col-md-6:eq(0)', table_5.table().container() ) );
  } );
...
<div class="container-fluid">
  <section>
    ...
    <div class="demo-html">
      <table id="spese_fascicolo" class="table table-striped table-bordered" style="width:100%">
        <thead>
        <tr>
          <th>Somma in euro</th>
          <th>Somma in dollari</th>
          <th>Rimborso</th>
          <th>Log utente</th>
          <th>Log azione</th>
